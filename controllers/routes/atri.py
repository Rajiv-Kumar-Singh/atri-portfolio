...
class Atri:
	def __init__(self, state: Any):
		...
		self.header__container = state["header__container"]
		self.header__menu = state["header__menu"]
		self.header__about = state["header__about"]
		self.header__services = state["header__services"]
		self.header__projects = state["header__projects"]
		self.header__blog = state["header__blog"]
		self.header__bookCall = state["header__bookCall"]
		self.clients = state["clients"]
		self.Flex11 = state["Flex11"]
		self.Flex12 = state["Flex12"]
		self.service = state["service"]
		self.services__header = state["services__header"]
		self.services__cardsContainer = state["services__cardsContainer"]
		self.services__innerCardsContainer = state["services__innerCardsContainer"]
		self.services__allServiceCard = state["services__allServiceCard"]
		self.Flex17 = state["Flex17"]
		self.Flex18 = state["Flex18"]
		self.hero = state["hero"]
		self.hero__container = state["hero__container"]
		self.Flex7 = state["Flex7"]
		self.Flex8 = state["Flex8"]
		self.hero__downloadBtn = state["hero__downloadBtn"]
		self.projects = state["projects"]
		self.project__container = state["project__container"]
		self.project__header = state["project__header"]
		self.project__titleBox = state["project__titleBox"]
		self.project__sliderContainer = state["project__sliderContainer"]
		self.project__sliderBox = state["project__sliderBox"]
		self.project__cardThree = state["project__cardThree"]
		self.projects__imageBox = state["projects__imageBox"]
		self.project__cardThreeTextBox = state["project__cardThreeTextBox"]
		self.Flex52 = state["Flex52"]
		self.project__cardTwo = state["project__cardTwo"]
		self.project__cardTwoTextBox = state["project__cardTwoTextBox"]
		self.Flex58 = state["Flex58"]
		self.Flex60 = state["Flex60"]
		self.project__cardFour = state["project__cardFour"]
		self.project__cardFourInfo = state["project__cardFourInfo"]
		self.Flex94 = state["Flex94"]
		self.Flex96 = state["Flex96"]
		self.project__cardOne = state["project__cardOne"]
		self.Flex99 = state["Flex99"]
		self.project__cardOneTextBox = state["project__cardOneTextBox"]
		self.Flex98 = state["Flex98"]
		self.blogs = state["blogs"]
		self.blogs__container = state["blogs__container"]
		self.blogs__sidebar = state["blogs__sidebar"]
		self.blogs__sidebarDetails = state["blogs__sidebarDetails"]
		self.blogs__contents = state["blogs__contents"]
		self.blogs__cardOne = state["blogs__cardOne"]
		self.Flex113 = state["Flex113"]
		self.blogs__cardOneLink = state["blogs__cardOneLink"]
		self.blogs__cardTwo = state["blogs__cardTwo"]
		self.blogs__cardTwoLink = state["blogs__cardTwoLink"]
		self.Flex119 = state["Flex119"]
		self.blogs__cardThree = state["blogs__cardThree"]
		self.Flex121 = state["Flex121"]
		self.blogs__cardThreeLink = state["blogs__cardThreeLink"]
		self.blogs__cardFour = state["blogs__cardFour"]
		self.blogs__cardFourLink = state["blogs__cardFourLink"]
		self.Flex125 = state["Flex125"]
		self.about = state["about"]
		self.Flex131 = state["Flex131"]
		self.Flex132 = state["Flex132"]
		self.about__gallery = state["about__gallery"]
		...
		self.about__info = state["about__info"]
		self.about__education = state["about__education"]
		self.about__eduHeader = state["about__eduHeader"]
		self.about__Cards = state["about__Cards"]
		self.about__Card = state["about__Card"]
		...
		self.about__experience = state["about__experience"]
		...
		self.testimonials__container = state["testimonials__container"]
		self.Flex176 = state["Flex176"]
		self.faq = state["faq"]
		self.faq__header = state["faq__header"]
		self.accordion__mainContainer = state["accordion__mainContainer"]
		self.Flex182 = state["Flex182"]
		self.Flex183 = state["Flex183"]
		self.footer = state["footer"]
		self.footer__header = state["footer__header"]
		self.footer__quickLinks = state["footer__quickLinks"]
		self.Flex219 = state["Flex219"]
		self.Flex221 = state["Flex221"]
		self.footer__quickLinkBox = state["footer__quickLinkBox"]
		self.Flex222 = state["Flex222"]
		self.Flex223 = state["Flex223"]
		self.Flex224 = state["Flex224"]
		self.footer__copyright = state["footer__copyright"]
		self.Iogo = state["Iogo"]
		self.header__aboutLink = state["header__aboutLink"]
		self.header__sevicesLink = state["header__sevicesLink"]
		self.header__projectsLink = state["header__projectsLink"]
		self.header__blogLink = state["header__blogLink"]
		self.header__bookCallLink = state["header__bookCallLink"]
		self.header__arrow = state["header__arrow"]
		self.clients__title = state["clients__title"]
		self.Image16 = state["Image16"]
		self.Image17 = state["Image17"]
		self.Image18 = state["Image18"]
		self.Image21 = state["Image21"]
		self.services__title = state["services__title"]
		self.services__description = state["services__description"]
		self.service__allServiceIcon = state["service__allServiceIcon"]
		self.services__cardOneTitle = state["services__cardOneTitle"]
		self.TextBox11 = state["TextBox11"]
		self.services__list = state["services__list"]
		self.service__techStackIcon = state["service__techStackIcon"]
		self.TextBox9 = state["TextBox9"]
		self.TextBox12 = state["TextBox12"]
		self.services__applicationList = state["services__applicationList"]
		self.Image24 = state["Image24"]
		self.TextBox10 = state["TextBox10"]
		self.TextBox13 = state["TextBox13"]
		self.services__expectation = state["services__expectation"]
		self.hero__image = state["hero__image"]
		self.hero__highlightText = state["hero__highlightText"]
		self.hero__text = state["hero__text"]
		self.hero__description = state["hero__description"]
		self.hero__button = state["hero__button"]
		self.Link13 = state["Link13"]
		self.hero__downloadCVArrow = state["hero__downloadCVArrow"]
		self.project__viewBtn = state["project__viewBtn"]
		self.project__title = state["project__title"]
		self.TextBox20 = state["TextBox20"]
		self.projects__image = state["projects__image"]
		self.project__cardTitle = state["project__cardTitle"]
		self.TextBox24 = state["TextBox24"]
		self.Image31 = state["Image31"]
		self.project__cardThreeLink = state["project__cardThreeLink"]
		self.TextBox31 = state["TextBox31"]
		self.TextBox32 = state["TextBox32"]
		self.project__cardTwoLink = state["project__cardTwoLink"]
		self.Image35 = state["Image35"]
		self.Image36 = state["Image36"]
		self.TextBox49 = state["TextBox49"]
		self.TextBox50 = state["TextBox50"]
		self.project__cardFourLink = state["project__cardFourLink"]
		...
		self.project__cardOneLink = state["project__cardOneLink"]
		self.blogs__title = state["blogs__title"]
		self.TextBox54 = state["TextBox54"]
		self.blogs__sidebarLink = state["blogs__sidebarLink"]
		...
		self.about__title = state["about__title"]
		...
		self.testimonials__innerContainer = state["testimonials__innerContainer"]
		self.testimonials__title = state["testimonials__title"]
		self.TextBox106 = state["TextBox106"]
		self.faq__title = state["faq__title"]
		...
		self.footer__topTitle = state["footer__topTitle"]
		self.footer__subTitle = state["footer__subTitle"]
		self.Image95 = state["Image95"]
		self.TextBox135 = state["TextBox135"]
		self.Image96 = state["Image96"]
		self.footer__mailId = state["footer__mailId"]
	...
	@property
	def header__container(self):
		self._getter_access_tracker["header__container"] = {}
		return self._header__container
	@header__container.setter
	def header__container(self, new_state):
		self._setter_access_tracker["header__container"] = {}
		global default_state
		self._header__container = Flex(new_state, default_state["header__container"])

	@property
	def header__menu(self):
		self._getter_access_tracker["header__menu"] = {}
		return self._header__menu
	@header__menu.setter
	def header__menu(self, new_state):
		self._setter_access_tracker["header__menu"] = {}
		global default_state
		self._header__menu = Flex(new_state, default_state["header__menu"])

	@property
	def header__about(self):
		self._getter_access_tracker["header__about"] = {}
		return self._header__about
	@header__about.setter
	def header__about(self, new_state):
		self._setter_access_tracker["header__about"] = {}
		global default_state
		self._header__about = Flex(new_state, default_state["header__about"])

	@property
	def header__services(self):
		self._getter_access_tracker["header__services"] = {}
		return self._header__services
	@header__services.setter
	def header__services(self, new_state):
		self._setter_access_tracker["header__services"] = {}
		global default_state
		self._header__services = Flex(new_state, default_state["header__services"])

	@property
	def header__projects(self):
		self._getter_access_tracker["header__projects"] = {}
		return self._header__projects
	@header__projects.setter
	def header__projects(self, new_state):
		self._setter_access_tracker["header__projects"] = {}
		global default_state
		self._header__projects = Flex(new_state, default_state["header__projects"])

	@property
	def header__blog(self):
		self._getter_access_tracker["header__blog"] = {}
		return self._header__blog
	@header__blog.setter
	def header__blog(self, new_state):
		self._setter_access_tracker["header__blog"] = {}
		global default_state
		self._header__blog = Flex(new_state, default_state["header__blog"])

	@property
	def header__bookCall(self):
		self._getter_access_tracker["header__bookCall"] = {}
		return self._header__bookCall
	@header__bookCall.setter
	def header__bookCall(self, new_state):
		self._setter_access_tracker["header__bookCall"] = {}
		global default_state
		self._header__bookCall = Flex(new_state, default_state["header__bookCall"])

	@property
	def clients(self):
		self._getter_access_tracker["clients"] = {}
		return self._clients
	@clients.setter
	def clients(self, new_state):
		self._setter_access_tracker["clients"] = {}
		global default_state
		self._clients = Div(new_state, default_state["clients"])
	...
	@property
	def services__header(self):
		self._getter_access_tracker["services__header"] = {}
		return self._services__header
	@services__header.setter
	def services__header(self, new_state):
		self._setter_access_tracker["services__header"] = {}
		global default_state
		self._services__header = Flex(new_state, default_state["services__header"])

	@property
	def services__cardsContainer(self):
		self._getter_access_tracker["services__cardsContainer"] = {}
		return self._services__cardsContainer
	@services__cardsContainer.setter
	def services__cardsContainer(self, new_state):
		self._setter_access_tracker["services__cardsContainer"] = {}
		global default_state
		self._services__cardsContainer = Flex(new_state, default_state["services__cardsContainer"])

	@property
	def services__innerCardsContainer(self):
		self._getter_access_tracker["services__innerCardsContainer"] = {}
		return self._services__innerCardsContainer
	@services__innerCardsContainer.setter
	def services__innerCardsContainer(self, new_state):
		self._setter_access_tracker["services__innerCardsContainer"] = {}
		global default_state
		self._services__innerCardsContainer = Flex(new_state, default_state["services__innerCardsContainer"])

	@property
	def services__allServiceCard(self):
		self._getter_access_tracker["services__allServiceCard"] = {}
		return self._services__allServiceCard
	@services__allServiceCard.setter
	def services__allServiceCard(self, new_state):
		self._setter_access_tracker["services__allServiceCard"] = {}
		global default_state
		self._services__allServiceCard = Flex(new_state, default_state["services__allServiceCard"])
	...
	@property
	def hero__container(self):
		self._getter_access_tracker["hero__container"] = {}
		return self._hero__container
	@hero__container.setter
	def hero__container(self, new_state):
		self._setter_access_tracker["hero__container"] = {}
		global default_state
		self._hero__container = Flex(new_state, default_state["hero__container"])
	...
	@property
	def hero__downloadBtn(self):
		self._getter_access_tracker["hero__downloadBtn"] = {}
		return self._hero__downloadBtn
	@hero__downloadBtn.setter
	def hero__downloadBtn(self, new_state):
		self._setter_access_tracker["hero__downloadBtn"] = {}
		global default_state
		self._hero__downloadBtn = Flex(new_state, default_state["hero__downloadBtn"])
	...
	@property
	def project__container(self):
		self._getter_access_tracker["project__container"] = {}
		return self._project__container
	@project__container.setter
	def project__container(self, new_state):
		self._setter_access_tracker["project__container"] = {}
		global default_state
		self._project__container = Flex(new_state, default_state["project__container"])

	@property
	def project__header(self):
		self._getter_access_tracker["project__header"] = {}
		return self._project__header
	@project__header.setter
	def project__header(self, new_state):
		self._setter_access_tracker["project__header"] = {}
		global default_state
		self._project__header = Flex(new_state, default_state["project__header"])

	@property
	def project__titleBox(self):
		self._getter_access_tracker["project__titleBox"] = {}
		return self._project__titleBox
	@project__titleBox.setter
	def project__titleBox(self, new_state):
		self._setter_access_tracker["project__titleBox"] = {}
		global default_state
		self._project__titleBox = Flex(new_state, default_state["project__titleBox"])

	@property
	def project__sliderContainer(self):
		self._getter_access_tracker["project__sliderContainer"] = {}
		return self._project__sliderContainer
	@project__sliderContainer.setter
	def project__sliderContainer(self, new_state):
		self._setter_access_tracker["project__sliderContainer"] = {}
		global default_state
		self._project__sliderContainer = Flex(new_state, default_state["project__sliderContainer"])

	@property
	def project__sliderBox(self):
		self._getter_access_tracker["project__sliderBox"] = {}
		return self._project__sliderBox
	@project__sliderBox.setter
	def project__sliderBox(self, new_state):
		self._setter_access_tracker["project__sliderBox"] = {}
		global default_state
		self._project__sliderBox = Flex(new_state, default_state["project__sliderBox"])

	@property
	def project__cardThree(self):
		self._getter_access_tracker["project__cardThree"] = {}
		return self._project__cardThree
	@project__cardThree.setter
	def project__cardThree(self, new_state):
		self._setter_access_tracker["project__cardThree"] = {}
		global default_state
		self._project__cardThree = Flex(new_state, default_state["project__cardThree"])

	@property
	def projects__imageBox(self):
		self._getter_access_tracker["projects__imageBox"] = {}
		return self._projects__imageBox
	@projects__imageBox.setter
	def projects__imageBox(self, new_state):
		self._setter_access_tracker["projects__imageBox"] = {}
		global default_state
		self._projects__imageBox = Flex(new_state, default_state["projects__imageBox"])

	@property
	def project__cardThreeTextBox(self):
		self._getter_access_tracker["project__cardThreeTextBox"] = {}
		return self._project__cardThreeTextBox
	@project__cardThreeTextBox.setter
	def project__cardThreeTextBox(self, new_state):
		self._setter_access_tracker["project__cardThreeTextBox"] = {}
		global default_state
		self._project__cardThreeTextBox = Flex(new_state, default_state["project__cardThreeTextBox"])
	...
	@property
	def project__cardTwo(self):
		self._getter_access_tracker["project__cardTwo"] = {}
		return self._project__cardTwo
	@project__cardTwo.setter
	def project__cardTwo(self, new_state):
		self._setter_access_tracker["project__cardTwo"] = {}
		global default_state
		self._project__cardTwo = Flex(new_state, default_state["project__cardTwo"])

	@property
	def project__cardTwoTextBox(self):
		self._getter_access_tracker["project__cardTwoTextBox"] = {}
		return self._project__cardTwoTextBox
	@project__cardTwoTextBox.setter
	def project__cardTwoTextBox(self, new_state):
		self._setter_access_tracker["project__cardTwoTextBox"] = {}
		global default_state
		self._project__cardTwoTextBox = Flex(new_state, default_state["project__cardTwoTextBox"])
	...
	@property
	def project__cardFour(self):
		self._getter_access_tracker["project__cardFour"] = {}
		return self._project__cardFour
	@project__cardFour.setter
	def project__cardFour(self, new_state):
		self._setter_access_tracker["project__cardFour"] = {}
		global default_state
		self._project__cardFour = Flex(new_state, default_state["project__cardFour"])

	@property
	def project__cardFourInfo(self):
		self._getter_access_tracker["project__cardFourInfo"] = {}
		return self._project__cardFourInfo
	@project__cardFourInfo.setter
	def project__cardFourInfo(self, new_state):
		self._setter_access_tracker["project__cardFourInfo"] = {}
		global default_state
		self._project__cardFourInfo = Flex(new_state, default_state["project__cardFourInfo"])
	...
	@property
	def project__cardOne(self):
		self._getter_access_tracker["project__cardOne"] = {}
		return self._project__cardOne
	@project__cardOne.setter
	def project__cardOne(self, new_state):
		self._setter_access_tracker["project__cardOne"] = {}
		global default_state
		self._project__cardOne = Flex(new_state, default_state["project__cardOne"])
	...
	@property
	def project__cardOneTextBox(self):
		self._getter_access_tracker["project__cardOneTextBox"] = {}
		return self._project__cardOneTextBox
	@project__cardOneTextBox.setter
	def project__cardOneTextBox(self, new_state):
		self._setter_access_tracker["project__cardOneTextBox"] = {}
		global default_state
		self._project__cardOneTextBox = Flex(new_state, default_state["project__cardOneTextBox"])
	...
	@property
	def blogs__container(self):
		self._getter_access_tracker["blogs__container"] = {}
		return self._blogs__container
	@blogs__container.setter
	def blogs__container(self, new_state):
		self._setter_access_tracker["blogs__container"] = {}
		global default_state
		self._blogs__container = Flex(new_state, default_state["blogs__container"])

	@property
	def blogs__sidebar(self):
		self._getter_access_tracker["blogs__sidebar"] = {}
		return self._blogs__sidebar
	@blogs__sidebar.setter
	def blogs__sidebar(self, new_state):
		self._setter_access_tracker["blogs__sidebar"] = {}
		global default_state
		self._blogs__sidebar = Flex(new_state, default_state["blogs__sidebar"])

	@property
	def blogs__sidebarDetails(self):
		self._getter_access_tracker["blogs__sidebarDetails"] = {}
		return self._blogs__sidebarDetails
	@blogs__sidebarDetails.setter
	def blogs__sidebarDetails(self, new_state):
		self._setter_access_tracker["blogs__sidebarDetails"] = {}
		global default_state
		self._blogs__sidebarDetails = Flex(new_state, default_state["blogs__sidebarDetails"])

	@property
	def blogs__contents(self):
		self._getter_access_tracker["blogs__contents"] = {}
		return self._blogs__contents
	@blogs__contents.setter
	def blogs__contents(self, new_state):
		self._setter_access_tracker["blogs__contents"] = {}
		global default_state
		self._blogs__contents = Flex(new_state, default_state["blogs__contents"])

	@property
	def blogs__cardOne(self):
		self._getter_access_tracker["blogs__cardOne"] = {}
		return self._blogs__cardOne
	@blogs__cardOne.setter
	def blogs__cardOne(self, new_state):
		self._setter_access_tracker["blogs__cardOne"] = {}
		global default_state
		self._blogs__cardOne = Flex(new_state, default_state["blogs__cardOne"])
	...
	@property
	def blogs__cardOneLink(self):
		self._getter_access_tracker["blogs__cardOneLink"] = {}
		return self._blogs__cardOneLink
	@blogs__cardOneLink.setter
	def blogs__cardOneLink(self, new_state):
		self._setter_access_tracker["blogs__cardOneLink"] = {}
		global default_state
		self._blogs__cardOneLink = Flex(new_state, default_state["blogs__cardOneLink"])

	@property
	def blogs__cardTwo(self):
		self._getter_access_tracker["blogs__cardTwo"] = {}
		return self._blogs__cardTwo
	@blogs__cardTwo.setter
	def blogs__cardTwo(self, new_state):
		self._setter_access_tracker["blogs__cardTwo"] = {}
		global default_state
		self._blogs__cardTwo = Flex(new_state, default_state["blogs__cardTwo"])

	@property
	def blogs__cardTwoLink(self):
		self._getter_access_tracker["blogs__cardTwoLink"] = {}
		return self._blogs__cardTwoLink
	@blogs__cardTwoLink.setter
	def blogs__cardTwoLink(self, new_state):
		self._setter_access_tracker["blogs__cardTwoLink"] = {}
		global default_state
		self._blogs__cardTwoLink = Flex(new_state, default_state["blogs__cardTwoLink"])
	...
	@property
	def blogs__cardThree(self):
		self._getter_access_tracker["blogs__cardThree"] = {}
		return self._blogs__cardThree
	@blogs__cardThree.setter
	def blogs__cardThree(self, new_state):
		self._setter_access_tracker["blogs__cardThree"] = {}
		global default_state
		self._blogs__cardThree = Flex(new_state, default_state["blogs__cardThree"])
	...
	@property
	def blogs__cardThreeLink(self):
		self._getter_access_tracker["blogs__cardThreeLink"] = {}
		return self._blogs__cardThreeLink
	@blogs__cardThreeLink.setter
	def blogs__cardThreeLink(self, new_state):
		self._setter_access_tracker["blogs__cardThreeLink"] = {}
		global default_state
		self._blogs__cardThreeLink = Flex(new_state, default_state["blogs__cardThreeLink"])

	@property
	def blogs__cardFour(self):
		self._getter_access_tracker["blogs__cardFour"] = {}
		return self._blogs__cardFour
	@blogs__cardFour.setter
	def blogs__cardFour(self, new_state):
		self._setter_access_tracker["blogs__cardFour"] = {}
		global default_state
		self._blogs__cardFour = Flex(new_state, default_state["blogs__cardFour"])

	@property
	def blogs__cardFourLink(self):
		self._getter_access_tracker["blogs__cardFourLink"] = {}
		return self._blogs__cardFourLink
	@blogs__cardFourLink.setter
	def blogs__cardFourLink(self, new_state):
		self._setter_access_tracker["blogs__cardFourLink"] = {}
		global default_state
		self._blogs__cardFourLink = Flex(new_state, default_state["blogs__cardFourLink"])
	...
	@property
	def about__gallery(self):
		self._getter_access_tracker["about__gallery"] = {}
		return self._about__gallery
	@about__gallery.setter
	def about__gallery(self, new_state):
		self._setter_access_tracker["about__gallery"] = {}
		global default_state
		self._about__gallery = Flex(new_state, default_state["about__gallery"])
	...
	@property
	def about__info(self):
		self._getter_access_tracker["about__info"] = {}
		return self._about__info
	@about__info.setter
	def about__info(self, new_state):
		self._setter_access_tracker["about__info"] = {}
		global default_state
		self._about__info = Flex(new_state, default_state["about__info"])

	@property
	def about__education(self):
		self._getter_access_tracker["about__education"] = {}
		return self._about__education
	@about__education.setter
	def about__education(self, new_state):
		self._setter_access_tracker["about__education"] = {}
		global default_state
		self._about__education = Flex(new_state, default_state["about__education"])

	@property
	def about__eduHeader(self):
		self._getter_access_tracker["about__eduHeader"] = {}
		return self._about__eduHeader
	@about__eduHeader.setter
	def about__eduHeader(self, new_state):
		self._setter_access_tracker["about__eduHeader"] = {}
		global default_state
		self._about__eduHeader = Flex(new_state, default_state["about__eduHeader"])

	@property
	def about__Cards(self):
		self._getter_access_tracker["about__Cards"] = {}
		return self._about__Cards
	@about__Cards.setter
	def about__Cards(self, new_state):
		self._setter_access_tracker["about__Cards"] = {}
		global default_state
		self._about__Cards = Flex(new_state, default_state["about__Cards"])

	@property
	def about__Card(self):
		self._getter_access_tracker["about__Card"] = {}
		return self._about__Card
	@about__Card.setter
	def about__Card(self, new_state):
		self._setter_access_tracker["about__Card"] = {}
		global default_state
		self._about__Card = Flex(new_state, default_state["about__Card"])
	...
	@property
	def about__experience(self):
		self._getter_access_tracker["about__experience"] = {}
		return self._about__experience
	@about__experience.setter
	def about__experience(self, new_state):
		self._setter_access_tracker["about__experience"] = {}
		global default_state
		self._about__experience = Flex(new_state, default_state["about__experience"])
	...
	@property
	def testimonials__container(self):
		self._getter_access_tracker["testimonials__container"] = {}
		return self._testimonials__container
	@testimonials__container.setter
	def testimonials__container(self, new_state):
		self._setter_access_tracker["testimonials__container"] = {}
		global default_state
		self._testimonials__container = Flex(new_state, default_state["testimonials__container"])
	...
	@property
	def faq__header(self):
		self._getter_access_tracker["faq__header"] = {}
		return self._faq__header
	@faq__header.setter
	def faq__header(self, new_state):
		self._setter_access_tracker["faq__header"] = {}
		global default_state
		self._faq__header = Flex(new_state, default_state["faq__header"])

	@property
	def accordion__mainContainer(self):
		self._getter_access_tracker["accordion__mainContainer"] = {}
		return self._accordion__mainContainer
	@accordion__mainContainer.setter
	def accordion__mainContainer(self, new_state):
		self._setter_access_tracker["accordion__mainContainer"] = {}
		global default_state
		self._accordion__mainContainer = Flex(new_state, default_state["accordion__mainContainer"])
	...
	@property
	def footer__header(self):
		self._getter_access_tracker["footer__header"] = {}
		return self._footer__header
	@footer__header.setter
	def footer__header(self, new_state):
		self._setter_access_tracker["footer__header"] = {}
		global default_state
		self._footer__header = Flex(new_state, default_state["footer__header"])

	@property
	def footer__quickLinks(self):
		self._getter_access_tracker["footer__quickLinks"] = {}
		return self._footer__quickLinks
	@footer__quickLinks.setter
	def footer__quickLinks(self, new_state):
		self._setter_access_tracker["footer__quickLinks"] = {}
		global default_state
		self._footer__quickLinks = Flex(new_state, default_state["footer__quickLinks"])
	...
	@property
	def footer__quickLinkBox(self):
		self._getter_access_tracker["footer__quickLinkBox"] = {}
		return self._footer__quickLinkBox
	@footer__quickLinkBox.setter
	def footer__quickLinkBox(self, new_state):
		self._setter_access_tracker["footer__quickLinkBox"] = {}
		global default_state
		self._footer__quickLinkBox = Flex(new_state, default_state["footer__quickLinkBox"])
	...
	@property
	def footer__copyright(self):
		self._getter_access_tracker["footer__copyright"] = {}
		return self._footer__copyright
	@footer__copyright.setter
	def footer__copyright(self, new_state):
		self._setter_access_tracker["footer__copyright"] = {}
		global default_state
		self._footer__copyright = Flex(new_state, default_state["footer__copyright"])

	@property
	def Iogo(self):
		self._getter_access_tracker["Iogo"] = {}
		return self._Iogo
	@Iogo.setter
	def Iogo(self, new_state):
		self._setter_access_tracker["Iogo"] = {}
		global default_state
		self._Iogo = Image(new_state, default_state["Iogo"])

	@property
	def header__aboutLink(self):
		self._getter_access_tracker["header__aboutLink"] = {}
		return self._header__aboutLink
	@header__aboutLink.setter
	def header__aboutLink(self, new_state):
		self._setter_access_tracker["header__aboutLink"] = {}
		global default_state
		self._header__aboutLink = Link(new_state, default_state["header__aboutLink"])

	@property
	def header__sevicesLink(self):
		self._getter_access_tracker["header__sevicesLink"] = {}
		return self._header__sevicesLink
	@header__sevicesLink.setter
	def header__sevicesLink(self, new_state):
		self._setter_access_tracker["header__sevicesLink"] = {}
		global default_state
		self._header__sevicesLink = Link(new_state, default_state["header__sevicesLink"])

	@property
	def header__projectsLink(self):
		self._getter_access_tracker["header__projectsLink"] = {}
		return self._header__projectsLink
	@header__projectsLink.setter
	def header__projectsLink(self, new_state):
		self._setter_access_tracker["header__projectsLink"] = {}
		global default_state
		self._header__projectsLink = Link(new_state, default_state["header__projectsLink"])

	@property
	def header__blogLink(self):
		self._getter_access_tracker["header__blogLink"] = {}
		return self._header__blogLink
	@header__blogLink.setter
	def header__blogLink(self, new_state):
		self._setter_access_tracker["header__blogLink"] = {}
		global default_state
		self._header__blogLink = Link(new_state, default_state["header__blogLink"])

	@property
	def header__bookCallLink(self):
		self._getter_access_tracker["header__bookCallLink"] = {}
		return self._header__bookCallLink
	@header__bookCallLink.setter
	def header__bookCallLink(self, new_state):
		self._setter_access_tracker["header__bookCallLink"] = {}
		global default_state
		self._header__bookCallLink = Link(new_state, default_state["header__bookCallLink"])

	@property
	def header__arrow(self):
		self._getter_access_tracker["header__arrow"] = {}
		return self._header__arrow
	@header__arrow.setter
	def header__arrow(self, new_state):
		self._setter_access_tracker["header__arrow"] = {}
		global default_state
		self._header__arrow = Image(new_state, default_state["header__arrow"])

	@property
	def clients__title(self):
		self._getter_access_tracker["clients__title"] = {}
		return self._clients__title
	@clients__title.setter
	def clients__title(self, new_state):
		self._setter_access_tracker["clients__title"] = {}
		global default_state
		self._clients__title = TextBox(new_state, default_state["clients__title"])
	...
	@property
	def services__title(self):
		self._getter_access_tracker["services__title"] = {}
		return self._services__title
	@services__title.setter
	def services__title(self, new_state):
		self._setter_access_tracker["services__title"] = {}
		global default_state
		self._services__title = TextBox(new_state, default_state["services__title"])

	@property
	def services__description(self):
		self._getter_access_tracker["services__description"] = {}
		return self._services__description
	@services__description.setter
	def services__description(self, new_state):
		self._setter_access_tracker["services__description"] = {}
		global default_state
		self._services__description = TextBox(new_state, default_state["services__description"])

	@property
	def service__allServiceIcon(self):
		self._getter_access_tracker["service__allServiceIcon"] = {}
		return self._service__allServiceIcon
	@service__allServiceIcon.setter
	def service__allServiceIcon(self, new_state):
		self._setter_access_tracker["service__allServiceIcon"] = {}
		global default_state
		self._service__allServiceIcon = Image(new_state, default_state["service__allServiceIcon"])

	@property
	def services__cardOneTitle(self):
		self._getter_access_tracker["services__cardOneTitle"] = {}
		return self._services__cardOneTitle
	@services__cardOneTitle.setter
	def services__cardOneTitle(self, new_state):
		self._setter_access_tracker["services__cardOneTitle"] = {}
		global default_state
		self._services__cardOneTitle = TextBox(new_state, default_state["services__cardOneTitle"])
	...
	@property
	def services__list(self):
		self._getter_access_tracker["services__list"] = {}
		return self._services__list
	@services__list.setter
	def services__list(self, new_state):
		self._setter_access_tracker["services__list"] = {}
		global default_state
		self._services__list = UnorderedList(new_state, default_state["services__list"])

	@property
	def service__techStackIcon(self):
		self._getter_access_tracker["service__techStackIcon"] = {}
		return self._service__techStackIcon
	@service__techStackIcon.setter
	def service__techStackIcon(self, new_state):
		self._setter_access_tracker["service__techStackIcon"] = {}
		global default_state
		self._service__techStackIcon = Image(new_state, default_state["service__techStackIcon"])
	...
	@property
	def services__applicationList(self):
		self._getter_access_tracker["services__applicationList"] = {}
		return self._services__applicationList
	@services__applicationList.setter
	def services__applicationList(self, new_state):
		self._setter_access_tracker["services__applicationList"] = {}
		global default_state
		self._services__applicationList = UnorderedList(new_state, default_state["services__applicationList"])
	...
	@property
	def services__expectation(self):
		self._getter_access_tracker["services__expectation"] = {}
		return self._services__expectation
	@services__expectation.setter
	def services__expectation(self, new_state):
		self._setter_access_tracker["services__expectation"] = {}
		global default_state
		self._services__expectation = UnorderedList(new_state, default_state["services__expectation"])

	@property
	def hero__image(self):
		self._getter_access_tracker["hero__image"] = {}
		return self._hero__image
	@hero__image.setter
	def hero__image(self, new_state):
		self._setter_access_tracker["hero__image"] = {}
		global default_state
		self._hero__image = Image(new_state, default_state["hero__image"])

	@property
	def hero__highlightText(self):
		self._getter_access_tracker["hero__highlightText"] = {}
		return self._hero__highlightText
	@hero__highlightText.setter
	def hero__highlightText(self, new_state):
		self._setter_access_tracker["hero__highlightText"] = {}
		global default_state
		self._hero__highlightText = TextBox(new_state, default_state["hero__highlightText"])
	...
	def hero__text(self, new_state):
		...
		global default_state
		self._hero__text = TextBox(new_state, default_state["hero__text"])

	@property
	def hero__description(self):
		self._getter_access_tracker["hero__description"] = {}
		return self._hero__description
	@hero__description.setter
	def hero__description(self, new_state):
		self._setter_access_tracker["hero__description"] = {}
		global default_state
		self._hero__description = TextBox(new_state, default_state["hero__description"])

	@property
	def hero__button(self):
		self._getter_access_tracker["hero__button"] = {}
		return self._hero__button
	@hero__button.setter
	def hero__button(self, new_state):
		self._setter_access_tracker["hero__button"] = {}
		global default_state
		self._hero__button = Button(new_state, default_state["hero__button"])
	...
	@property
	def hero__downloadCVArrow(self):
		self._getter_access_tracker["hero__downloadCVArrow"] = {}
		return self._hero__downloadCVArrow
	@hero__downloadCVArrow.setter
	def hero__downloadCVArrow(self, new_state):
		self._setter_access_tracker["hero__downloadCVArrow"] = {}
		global default_state
		self._hero__downloadCVArrow = Image(new_state, default_state["hero__downloadCVArrow"])

	@property
	def project__viewBtn(self):
		self._getter_access_tracker["project__viewBtn"] = {}
		return self._project__viewBtn
	@project__viewBtn.setter
	def project__viewBtn(self, new_state):
		self._setter_access_tracker["project__viewBtn"] = {}
		global default_state
		self._project__viewBtn = Button(new_state, default_state["project__viewBtn"])

	@property
	def project__title(self):
		self._getter_access_tracker["project__title"] = {}
		return self._project__title
	@project__title.setter
	def project__title(self, new_state):
		self._setter_access_tracker["project__title"] = {}
		global default_state
		self._project__title = TextBox(new_state, default_state["project__title"])
	...
	@property
	def projects__image(self):
		self._getter_access_tracker["projects__image"] = {}
		return self._projects__image
	@projects__image.setter
	def projects__image(self, new_state):
		self._setter_access_tracker["projects__image"] = {}
		global default_state
		self._projects__image = Image(new_state, default_state["projects__image"])

	@property
	def project__cardTitle(self):
		self._getter_access_tracker["project__cardTitle"] = {}
		return self._project__cardTitle
	@project__cardTitle.setter
	def project__cardTitle(self, new_state):
		self._setter_access_tracker["project__cardTitle"] = {}
		global default_state
		self._project__cardTitle = TextBox(new_state, default_state["project__cardTitle"])
	...
	@property
	def project__cardThreeLink(self):
		self._getter_access_tracker["project__cardThreeLink"] = {}
		return self._project__cardThreeLink
	@project__cardThreeLink.setter
	def project__cardThreeLink(self, new_state):
		self._setter_access_tracker["project__cardThreeLink"] = {}
		global default_state
		self._project__cardThreeLink = Link(new_state, default_state["project__cardThreeLink"])
	...
	@property
	def project__cardTwoLink(self):
		self._getter_access_tracker["project__cardTwoLink"] = {}
		return self._project__cardTwoLink
	@project__cardTwoLink.setter
	def project__cardTwoLink(self, new_state):
		self._setter_access_tracker["project__cardTwoLink"] = {}
		global default_state
		self._project__cardTwoLink = Link(new_state, default_state["project__cardTwoLink"])
	...
	@property
	def project__cardFourLink(self):
		self._getter_access_tracker["project__cardFourLink"] = {}
		return self._project__cardFourLink
	@project__cardFourLink.setter
	def project__cardFourLink(self, new_state):
		self._setter_access_tracker["project__cardFourLink"] = {}
		global default_state
		self._project__cardFourLink = Link(new_state, default_state["project__cardFourLink"])
	...
	@property
	def project__cardOneLink(self):
		self._getter_access_tracker["project__cardOneLink"] = {}
		return self._project__cardOneLink
	@project__cardOneLink.setter
	def project__cardOneLink(self, new_state):
		self._setter_access_tracker["project__cardOneLink"] = {}
		global default_state
		self._project__cardOneLink = Link(new_state, default_state["project__cardOneLink"])

	@property
	def blogs__title(self):
		self._getter_access_tracker["blogs__title"] = {}
		return self._blogs__title
	@blogs__title.setter
	def blogs__title(self, new_state):
		self._setter_access_tracker["blogs__title"] = {}
		global default_state
		self._blogs__title = TextBox(new_state, default_state["blogs__title"])
	...
	@property
	def blogs__sidebarLink(self):
		self._getter_access_tracker["blogs__sidebarLink"] = {}
		return self._blogs__sidebarLink
	@blogs__sidebarLink.setter
	def blogs__sidebarLink(self, new_state):
		self._setter_access_tracker["blogs__sidebarLink"] = {}
		global default_state
		self._blogs__sidebarLink = Link(new_state, default_state["blogs__sidebarLink"])
	...
	@property
	def about__title(self):
		self._getter_access_tracker["about__title"] = {}
		return self._about__title
	@about__title.setter
	def about__title(self, new_state):
		self._setter_access_tracker["about__title"] = {}
		global default_state
		self._about__title = TextBox(new_state, default_state["about__title"])
	...
	@property
	def testimonials__innerContainer(self):
		self._getter_access_tracker["testimonials__innerContainer"] = {}
		return self._testimonials__innerContainer
	@testimonials__innerContainer.setter
	def testimonials__innerContainer(self, new_state):
		self._setter_access_tracker["testimonials__innerContainer"] = {}
		global default_state
		self._testimonials__innerContainer = Testimonial(new_state, default_state["testimonials__innerContainer"])

	@property
	def testimonials__title(self):
		self._getter_access_tracker["testimonials__title"] = {}
		return self._testimonials__title
	@testimonials__title.setter
	def testimonials__title(self, new_state):
		self._setter_access_tracker["testimonials__title"] = {}
		global default_state
		self._testimonials__title = TextBox(new_state, default_state["testimonials__title"])
	...
	@property
	def faq__title(self):
		self._getter_access_tracker["faq__title"] = {}
		return self._faq__title
	@faq__title.setter
	def faq__title(self, new_state):
		self._setter_access_tracker["faq__title"] = {}
		global default_state
		self._faq__title = TextBox(new_state, default_state["faq__title"])
	...
	@property
	def footer__topTitle(self):
		self._getter_access_tracker["footer__topTitle"] = {}
		return self._footer__topTitle
	@footer__topTitle.setter
	def footer__topTitle(self, new_state):
		self._setter_access_tracker["footer__topTitle"] = {}
		global default_state
		self._footer__topTitle = TextBox(new_state, default_state["footer__topTitle"])

	@property
	def footer__subTitle(self):
		self._getter_access_tracker["footer__subTitle"] = {}
		return self._footer__subTitle
	@footer__subTitle.setter
	def footer__subTitle(self, new_state):
		self._setter_access_tracker["footer__subTitle"] = {}
		global default_state
		self._footer__subTitle = TextBox(new_state, default_state["footer__subTitle"])
	...
	@property
	def footer__mailId(self):
		self._getter_access_tracker["footer__mailId"] = {}
		return self._footer__mailId
	@footer__mailId.setter
	def footer__mailId(self, new_state):
		self._setter_access_tracker["footer__mailId"] = {}
		global default_state
		self._footer__mailId = Link(new_state, default_state["footer__mailId"])
	...
	def _to_json_fields(self):
		return {
			"header": self._header,
			"header__container": self._header__container,
			"header__menu": self._header__menu,
			"header__about": self._header__about,
			"header__services": self._header__services,
			"header__projects": self._header__projects,
			"header__blog": self._header__blog,
			"header__bookCall": self._header__bookCall,
			"clients": self._clients,
			"Flex11": self._Flex11,
			"Flex12": self._Flex12,
			"service": self._service,
			"services__header": self._services__header,
			"services__cardsContainer": self._services__cardsContainer,
			"services__innerCardsContainer": self._services__innerCardsContainer,
			"services__allServiceCard": self._services__allServiceCard,
			"Flex17": self._Flex17,
			"Flex18": self._Flex18,
			"hero": self._hero,
			"hero__container": self._hero__container,
			"Flex7": self._Flex7,
			"Flex8": self._Flex8,
			"hero__downloadBtn": self._hero__downloadBtn,
			"projects": self._projects,
			"project__container": self._project__container,
			"project__header": self._project__header,
			"project__titleBox": self._project__titleBox,
			"project__sliderContainer": self._project__sliderContainer,
			"project__sliderBox": self._project__sliderBox,
			"project__cardThree": self._project__cardThree,
			"projects__imageBox": self._projects__imageBox,
			"project__cardThreeTextBox": self._project__cardThreeTextBox,
			"Flex52": self._Flex52,
			"project__cardTwo": self._project__cardTwo,
			"project__cardTwoTextBox": self._project__cardTwoTextBox,
			"Flex58": self._Flex58,
			"Flex60": self._Flex60,
			"project__cardFour": self._project__cardFour,
			"project__cardFourInfo": self._project__cardFourInfo,
			"Flex94": self._Flex94,
			"Flex96": self._Flex96,
			"project__cardOne": self._project__cardOne,
			"Flex99": self._Flex99,
			"project__cardOneTextBox": self._project__cardOneTextBox,
			"Flex98": self._Flex98,
			"blogs": self._blogs,
			"blogs__container": self._blogs__container,
			"blogs__sidebar": self._blogs__sidebar,
			"blogs__sidebarDetails": self._blogs__sidebarDetails,
			"blogs__contents": self._blogs__contents,
			"blogs__cardOne": self._blogs__cardOne,
			"Flex113": self._Flex113,
			"blogs__cardOneLink": self._blogs__cardOneLink,
			"blogs__cardTwo": self._blogs__cardTwo,
			"blogs__cardTwoLink": self._blogs__cardTwoLink,
			"Flex119": self._Flex119,
			"blogs__cardThree": self._blogs__cardThree,
			"Flex121": self._Flex121,
			"blogs__cardThreeLink": self._blogs__cardThreeLink,
			"blogs__cardFour": self._blogs__cardFour,
			"blogs__cardFourLink": self._blogs__cardFourLink,
			"Flex125": self._Flex125,
			"about": self._about,
			"Flex131": self._Flex131,
			"Flex132": self._Flex132,
			"about__gallery": self._about__gallery,
			"Flex134": self._Flex134,
			"Flex135": self._Flex135,
			"Flex136": self._Flex136,
			"Flex140": self._Flex140,
			"Flex141": self._Flex141,
			"about__info": self._about__info,
			"about__education": self._about__education,
			"about__eduHeader": self._about__eduHeader,
			"about__Cards": self._about__Cards,
			"about__Card": self._about__Card,
			...
			"about__experience": self._about__experience,
			...
			"testimonials__container": self._testimonials__container,
			"Flex176": self._Flex176,
			"faq": self._faq,
			"faq__header": self._faq__header,
			"accordion__mainContainer": self._accordion__mainContainer,
			"Flex182": self._Flex182,
			"Flex183": self._Flex183,
			"footer": self._footer,
			"footer__header": self._footer__header,
			"footer__quickLinks": self._footer__quickLinks,
			"Flex219": self._Flex219,
			"Flex221": self._Flex221,
			"footer__quickLinkBox": self._footer__quickLinkBox,
			"Flex222": self._Flex222,
			"Flex223": self._Flex223,
			"Flex224": self._Flex224,
			"footer__copyright": self._footer__copyright,
			"Iogo": self._Iogo,
			"header__aboutLink": self._header__aboutLink,
			"header__sevicesLink": self._header__sevicesLink,
			"header__projectsLink": self._header__projectsLink,
			"header__blogLink": self._header__blogLink,
			"header__bookCallLink": self._header__bookCallLink,
			"header__arrow": self._header__arrow,
			"clients__title": self._clients__title,
			"Image16": self._Image16,
			"Image17": self._Image17,
			"Image18": self._Image18,
			"Image21": self._Image21,
			"services__title": self._services__title,
			"services__description": self._services__description,
			"service__allServiceIcon": self._service__allServiceIcon,
			"services__cardOneTitle": self._services__cardOneTitle,
			"TextBox11": self._TextBox11,
			"services__list": self._services__list,
			"service__techStackIcon": self._service__techStackIcon,
			"TextBox9": self._TextBox9,
			"TextBox12": self._TextBox12,
			"services__applicationList": self._services__applicationList,
			"Image24": self._Image24,
			"TextBox10": self._TextBox10,
			"TextBox13": self._TextBox13,
			"services__expectation": self._services__expectation,
			"hero__image": self._hero__image,
			"hero__highlightText": self._hero__highlightText,
			"hero__text": self._hero__text,
			"hero__description": self._hero__description,
			"hero__button": self._hero__button,
			"Link13": self._Link13,
			"hero__downloadCVArrow": self._hero__downloadCVArrow,
			"project__viewBtn": self._project__viewBtn,
			"project__title": self._project__title,
			"TextBox20": self._TextBox20,
			"projects__image": self._projects__image,
			"project__cardTitle": self._project__cardTitle,
			"TextBox24": self._TextBox24,
			"Image31": self._Image31,
			"project__cardThreeLink": self._project__cardThreeLink,
			"TextBox31": self._TextBox31,
			"TextBox32": self._TextBox32,
			"project__cardTwoLink": self._project__cardTwoLink,
			"Image35": self._Image35,
			"Image36": self._Image36,
			"TextBox49": self._TextBox49,
			"TextBox50": self._TextBox50,
			"project__cardFourLink": self._project__cardFourLink,
			...
			"project__cardOneLink": self._project__cardOneLink,
			"blogs__title": self._blogs__title,
			"TextBox54": self._TextBox54,
			"blogs__sidebarLink": self._blogs__sidebarLink,
			...
			"about__title": self._about__title,
			...
			"testimonials__innerContainer": self._testimonials__innerContainer,
			"testimonials__title": self._testimonials__title,
			"TextBox106": self._TextBox106,
			"faq__title": self._faq__title,
			...
			"footer__topTitle": self._footer__topTitle,
			"footer__subTitle": self._footer__subTitle,
			"Image95": self._Image95,
			"TextBox135": self._TextBox135,
			"Image96": self._Image96,
			"footer__mailId": self._footer__mailId,
			"Link41": self._Link41,
			"Link43": self._Link43,
			"Link44": self._Link44,
			"Link37": self._Link37,
